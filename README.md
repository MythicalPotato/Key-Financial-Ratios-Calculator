...
3. OPTIONAL: Input stock split data. There is already a robust stock split checker in the code.
...
EPS Dropoff / Missed Stock Splits:
    ...
    1. Ensure that you have added ALL of the stock splits that a company has gone 2. 2. through over your desired period of time are imputed
    3. Input the splits manually, as shown in personalization
    4. There is a bug (verify through the SEC filing), make a Bug Fix comment
